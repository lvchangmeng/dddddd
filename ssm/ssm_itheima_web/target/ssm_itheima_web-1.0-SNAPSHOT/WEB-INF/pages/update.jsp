...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/user/updateUser" method="post">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" value="${user.username}" name="username" placeholder="请输入姓名">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="password" class="form-control" id="pwd" value="${user.pwd}" name="pwd" placeholder="请输入密码">
        </div>
        <div class="form-group">
            <label>性别：</label>
